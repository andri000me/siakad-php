...
?>
 ...
 <div class="col-xl-12 col-lg-7" style="margin-left: auto;    margin-right: auto;">
              <div class="card shadow mb-4">
                ...
                <h6 class="m-0 font-weight-bold text-primary">Data Daftar Siswa</h6>
                ...
                <div class="table-responsive">
                  ...
                  <Label> Cari Nama :</label>
                      ...
                      <a class="btn btn-success" href="inputdatasiswa.php?id_angkatan=<?php echo "$id&&id_admin=$id_admin"?>">[+] Tambah Siswa Baru</a>           
                    </div>
  ...
  $getData = mysqlI_query($db,"SELECT*FROM siswa LIMIT $mulai, $halaman");
$i=0;
    ...
    $i++;
		...
		echo"<td style='max-width:200px'>".$siswa['nama_siswa']."</td>";
		echo"<td style='width:100px' >".$siswa['kelas']."</td>";
    ...
    echo"<td>
    <a href='editsiswa.php?id_siswa=".$siswa['id_siswa']."&&id_angkatan=".$siswa['id_angkatan']."&&id_admin=$id_admin'>Edit</a> / 
    <a href='hapus.php?id=".$siswa['id_siswa']."&&type=siswa&&id_admin=$id_admin'>Hapus</a></td>";
