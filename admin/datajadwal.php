...
?>
 ...
 <div class="col-xl-12 col-lg-7" style="margin-left: auto;    margin-right: auto;">
	...
	$sql="SELECT * FROM kelas LEFT JOIN guru ON kelas.id_kelas = guru.id_kelas WHERE kelas.id_kelas !=0";
  $query=mysqli_query($db,$sql);
  $total = mysqli_num_rows($query);
  $pages = ceil($total/$halaman); 
  $getData = mysqlI_query($db,"SELECT * FROM kelas LEFT JOIN guru ON kelas.id_kelas = guru.id_kelas WHERE kelas.id_kelas != 0 LIMIT $mulai, $halaman");
$i=0;
    ...
    if($siswa['semester']==1){
      ...
      $semester="Semster Genap";
		...
		echo"<td>	<a href='editjadwal.php?id_kelas=".$siswa['id_kelas']."&&id_angkatan=".$siswa['id_angkatan']."&&id_admin=$id_admin'>Edit / </a> <a href='jadwaldetail.php?id_kelas=".$siswa['id_kelas']."&&hari=senin&&id_admin=$id_admin'>Lihat</a> <a href='hapus.php?id=".$siswa['id_kelas']."&&type=jadwal&&id_admin=$id_admin'>/ Hapus</a></td>";
