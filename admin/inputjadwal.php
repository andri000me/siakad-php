...
<div class="col-xl-6 col-lg-12" style="margin-left: auto;    margin-right: auto;">
   <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
         <h6 class="m-0 font-weight-bold text-primary">Form Input Jadwal</h6>

      </div>
      <!-- Card Body -->
      <div class="card-body">
         <div class="table-responsive">
            <form class="user" name="tambah_siswa" method="post" action="inputjadwal.php?id_angkatan=<?php echo "$id_angkatan&&id_kelas=$id_kelas&&id_admin=$id_admin"; ?>" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  <div class="container">
                     <div class="row" style="border-left:solid 3px blue; padding-left:5px;">
                        <h5 styl="padding:5px; color:black; ">Pilih Kelas :</h5>
                     </div>
                  </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-9">
                           <select id="kelas" onchange="cek()" name="kelas" class="form-control" id="exampleFormControlSelect1">
                              <option value="select">- Pilih -</option>
                              <?php
                              $sql = "SELECT * FROM kelas WHERE id_thn_akad = '$id_angkatan' ";
                              $hasil = mysqli_query($kon, $sql);
                              while ($jumlah = mysqli_fetch_array($hasil)) {
                                 echo '<option value="' . $jumlah['id_kelas'] . '">' . $jumlah['nama_kelas'] . '</option>';
                              }
                              ?>
                        </div>
                     </div>
