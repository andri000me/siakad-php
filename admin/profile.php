...
$getData = mysqli_query($db,"SELECT * FROM user WHERE id_user = '$id_admin'");
...
{   
    ...
    $inputUser = mysqli_query($db,"UPDATE user set nama='$nama',username='$username',password='$password' WHERE id_user='$id_admin'");
    ...
    header("Location:profile.php?id_admin=$id_admin");
} 
?>
...
<div class="col-xl-6 col-lg-12" style="margin-left: auto;    margin-right: auto;">
              <div class="card shadow mb-4">
                ...
                <form class="user" name="tambah_siswa" method="post" action="profile.php?id_admin=<?php echo $id_admin ?>" enctype="multipart/form-data">
