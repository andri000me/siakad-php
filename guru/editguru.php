...
{   
    ...
    // echo $id;
    $agama=$_POST['agama'];
    $inputSiswa = mysqli_query($db,"UPDATE guru SET foto='$image' ,nuptk='$nuptk', nama_guru='$nama',alamat='$alamatUP', no_hp='$teleponUP', email='$email', agama='$agama', tempat_lahir='$tempat', tanggal_lahir='$ttl', status='$status', jenis_kelamin='$jenis_k' WHERE id_guru='$id_guru'");
    ...
    header("Location:index.php?id=$id_guru");
} 
?>
...
<div class="col-xl-6 col-lg-12" style="margin-left: auto;    margin-right: auto;">
              <div class="card shadow mb-4">
                ...
                <form class="user" name="tambah_siswa" method="post" action='editguru.php?id=<?php echo"$id_guru"; ?>' enctype="multipart/form-data">
