                ...
                <div class="table-responsive">
                  ...
                  <h5 style="margin-right:10px;"> Hari : </h5>
                       ...
                       <input type="hidden" id="guru" value="<?php echo"$id_guru"; ?> "> 
                        <select style="border-color: gainsboro; border-radius: 5px;" onchange="cek()" id="hari" name="hari" >
...
// console.log(data);
      var urlID = "jadwal.php?id="+id_guru+"&&id_kelas="+id+"&&hari="+hari+"&&id_angkatan="+id_angkatan;
      console.log(urlID);
        $.ajax({
