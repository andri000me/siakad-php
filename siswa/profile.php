...
{   
    ...
    header("Location:profile.php?id=$id_siswa");
} 
?>
...
<div class="col-xl-6 col-lg-12" style="margin-left: auto;    margin-right: auto;">
              <div class="card shadow mb-4">
                ...
                <form class="user" name="tambah_siswa" method="post" action="profile.php?id=<?php echo $id_siswa ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                   ...
                   <div class="col-9">
                    ...
                    <input type="submit" style="max-width:40%; margin-left:auto; margin-right:auto;" name="update" class="btn btn-primary btn-user btn-block" value="Update User">
